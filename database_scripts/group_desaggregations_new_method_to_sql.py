...
with open('group_desaggregations_new_method.json','r') as f:
    ...
    for desagg in group_desaggregations:
        ...
        for ratio in desagg['ratios']:
            ...
            insert_data.update(dict((k,v) for k,v in ratio.iteritems() if 'partner' in k))
    ...
    #     partners_to_complete_values.append([v for k,v in partner.iteritems() if k in partners_to_complete_keys ]+ [partner['RICname']])
