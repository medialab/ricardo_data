...
(year, reporting, reporting_type, reporting_continent, reporting_slug, partner, partner_type, partner_continent, partner_slug, flow, unit, rate, expimp, quality_tag, type, notes )
SELECT year, reporting, reporting_type, reporting_continent, reporting_slug, partner_part_of_country as partner, pp.type as partner_type, pp.continent as partner_continent, pp.slug as partner_slug,
